...
expName = 'raceface'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/kellycotton/Dropbox/Research/N3/raceface_lastrun.py',
...
block = data.TrialHandler(nReps=2.0, method='random', 
    ...
    trialList=data.importConditions('routine_conditions/raceface.csv'),
...
for thisBlock in block:
    ...
    # set up handler to look after randomisation of conditions etc
    trials = data.TrialHandler(nReps=num_faces, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
    ...
    for thisTrial in trials:
        ...
        image.setImage(image_present)
        # keep track of which components have finished
        face_presentComponents = [image]
        ...
        while continueRoutine:
            ...
            if image.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > image.tStartRefresh + facepresent_time-frameTolerance:
                    # keep track of stop time/frame for later
    ...
    # completed num_faces repeats of 'trials'
